...
# Created:   01/10/2015
# Need to Update on 11182016: 1) Change the mannual modification regarding the daily saving impact by using an query for get the 19:00:00 ZULU data and the Data query method
#                             2) Correct the error handling regarding to the downloadind issue (
#-------------------------------------------------------------------------------
import time
import os
import sys
...
# not daylight saving version
##Updated on 11/05/2016 for the next day of daily saving time
