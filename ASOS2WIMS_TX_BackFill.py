...
##    else:
##        X['Type']='R'
    ##Updated on 04/12/2017 to remove the impact from day saving issues!
    UTC_Hour = row['observation_time'][11:13]
...
##Create the starttime and end time string for downloading
StartTime  =  TWODAYSTR + UTCHOUR
EndTime = TODATSTR + UTCHOUR
...
##StartTime = '2017-04-01T19:00:00Z'
##EndTime= '2017-04-03T19:00:00Z'
