...
##            asos.loc[hour,'PRCP3HOUR']=asos.loc[hour,'precip_in'] + asos.loc[hour+1,'precip_in'] + asos.loc[hour+2,'precip_in']
        ...
        #11-23-2015 Suggested by Mike: change the season code to 4, the herbaceous greenness factor to 0, and
        # the shrub greenness factor to 10 for the following stations: 411701, 412001, 413901, 417803, 418003, 418103, 418104, 418105, 419404, 419603, 419703
...
def Report(asos,X,row):
    ...
    #Get the season code and
    #'Herb':20, 'Shrub':15,'SeasonCode':3
