...
#import default libraries in python
import string
import time
import re
import sys
...
#import emailIt Is emailIt a library created by themself?
#davclient library for submitting files to the web
import davclient
#import metar for interpreting metar data(the most recent of metar is 1.2)
from metar import Metar
#configuration file parser provides a structure similar to Windows INI files.
import ConfigParser
...
#Showing the current time for running the script
