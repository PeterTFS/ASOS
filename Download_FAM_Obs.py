...
##    end = '22-Mar-16'
    ...
    if serverResponse.getcode() == 200:
        # Observations
        url = "https://fam.nwcg.gov/wims/xsql/obs.xsql?stn=" + str(stationid) + "&sig=&type=O&start=" + start + "&end=" + end + "&time=&user=mdunivan&priority="
        print url
        ...
        print 'Downloaded ASOS from fam for station:'+ str(stationid)
